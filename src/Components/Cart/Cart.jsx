...
export default function Cart() {
  ...
  const { getUserCart, deleteItem, updateItemQuantity, setCartId, setnumOfItems, clearCart } = useContext(cartContext);
  ...
  return (
    <>
      ...
      <div className="container bg-main-light my-5 p-5">
        ...
        {loading ? <Loader /> : (cartDetails.data?.products && cartDetails.data.products.length ? (
